                        ...
                        <div class="aspect-w-1 aspect-h-1 relative">
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-200 flex items-center justify-center">
                                <button
                                    ...
                                    @click="vote(photo.id)"
                                    :disabled="processing"
                                    class="opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-medium flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                ...
                                <button
                                    ...
                                    :disabled="processing"
                                    class="opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-medium flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                        ...
                        <div class="p-4">
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center space-x-1">
                                    ...
                                    <span class="text-xs font-medium text-gray-900">{{ photo.vote_count }}</span>
                                </div>
