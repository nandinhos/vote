                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-2xl font-bold text-gray-900">{{ votes ? votes.total : 0 }}</span>
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm font-medium text-gray-500">Votantes Únicos</span>
                                        <span class="text-lg font-semibold text-gray-900">{{ votes ? votes.data.length : 0 }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <Link :href="route('admin.projects.show', photo.project.id)" class="block text-indigo-600 hover:text-indigo-900 font-medium">
                                            {{ photo.project.name }}
                                        </Link>
                                    </div>
                                    <div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <span class="block text-sm text-gray-900">{{ formatDate(photo.created_at) }}</span>
                                    </div>
                                    <div>
                                        <span class="text-sm font-medium text-gray-500">Última atualização:</span>
                                        <span class="block text-sm text-gray-900">{{ formatDate(photo.updated_at) }}</span>
                                    </div>
                                    <div>
                                        <span class="text-sm font-medium text-gray-500">Arquivo:</span>
                                        <span class="block text-sm text-gray-900">{{ photo.file_path.split('/').pop() }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
