                        ...
                        <div class="p-6">
                            ...
                            <div v-if="photo && Object.keys(photo).length > 0" class="space-y-2 text-sm text-gray-600">
                                <div class="flex justify-between">
                                    ...
                                    <Link v-if="photo.project && photo.project.id" :href="route('admin.projects.show', photo.project.id)" class="text-indigo-600 hover:text-indigo-900">
                                        {{ photo.project.name }}
                                    </Link>
                            ...
                            <form @submit.prevent="submit">
                                <div class="mb-6">
                                    ...
                                    >
                                        ...
                                        <option v-for="project in (projects || [])" :key="project.id || project.name" :value="project.id">
                                            {{ project.name }}
                                        </option>
                                    </select>
                                    ...
                                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md"
                                        ...
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div v-else class="relative">
                                                <img :src="photoPreview" alt="Preview" class="mx-auto h-32 w-auto rounded-lg">
                                                <button
                                                    type="button"
                                                    @click="removePhoto"
