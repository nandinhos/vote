        ...
        <template #header>
            <div class="w-full">
                <div class="flex items-center space-x-4 mb-2">
                    <Link :href="route('admin.projects.index')" class="text-gray-500 hover:text-gray-700"> <svg
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-2 mt-1"> <span
                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"
                                :class="project.is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'">
                                {{ project.is_active ? 'Ativo' : 'Inativo' }} </span> <span
                                class="text-sm text-gray-500">Criado em {{ formatDate(project.created_at) }}</span>
                        </div>
                    </div>
                </div>
                <div class="fixed top-4 right-16 flex space-x-2">
                    <div class="flex space-x-2">
                        ...
                        Editar </Link>
                        <Link :href="route('admin.photos.create', { project_id: project.id })"
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-2xl font-bold text-gray-900">{{ topPhoto ? topPhoto.vote_count : 0
                                        }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-2xl font-bold text-gray-900">{{ project.unique_voters_count }}
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="p-4">
                                    <div class="flex items-center justify-between mb-2">
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span class="text-sm font-medium text-gray-900">{{ photo.vote_count
                                                }}</span>
                                        </div>
                                        <div class="flex space-x-2">
                                            ...
                                            <button @click="confirmDeletePhoto(photo)"
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Adicionada em {{ formatDate(photo.created_at)
                                        }}</p>
                                </div>
                            </div>
                        </div>
